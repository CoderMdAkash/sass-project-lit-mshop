        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow flag-nav">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    {{-- <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('superAdmin/images/flags/fr.png') }}" alt="" height="16"> French
                    </a>
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('superAdmin/images/flags/es.png') }}" alt="" height="16"> Spanish
                    </a>
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('superAdmin/images/flags/de.png') }}" alt="" height="16"> German
                    </a> --}}
                </div>
            </li>
                        ...
                        {{-- <ul class="notification-list">
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media d-flex">
                                        <span class="avatar flex-shrink-0">
                                            <img alt="" src="{{ asset('superAdmin/images/profiles/avatar-03.jpg') }}">
                                        </span>
                                        <div class="media-body flex-grow-1">
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media d-flex">
                                        <span class="avatar flex-shrink-0">
                                            <img alt="" src="{{ asset('superAdmin/images/profiles/avatar-06.jpg') }}">
                                        </span>
                                        <div class="media-body flex-grow-1">
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media d-flex">
                                        <span class="avatar flex-shrink-0">
                                            <img alt="" src="{{ asset('superAdmin/images/profiles/avatar-17.jpg') }}">
                                        </span>
                                        <div class="media-body flex-grow-1">
                            ...
                            <li class="notification-message">
                                <a href="activities.html">
                                    <div class="media d-flex">
                                        <span class="avatar flex-shrink-0">
                                            <img alt="" src="{{ asset('superAdmin/images/profiles/avatar-13.jpg') }}">
                                        </span>
                                        <div class="media-body flex-grow-1">
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                ...
                <div class="dropdown-menu menu-drop-user">
                    <div class="profilename">
                        ...
                        <hr class="m-0">
                        <a class="dropdown-item logout pb-0" href="{{ route('logout') }}"><img src="{{ asset('superAdmin/images/icons/log-out.svg') }}" class="me-2" alt="img">Logout</a>
                    </div>
                </div>
            </li>
        </ul>
